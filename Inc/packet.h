...
/**
 *  @brief      Send a DWM packet via UART.
 *  The host is expected to use the data in this packet to graphically
 *  represent the device positions. 
 *  @param[in]  anchorState     Anchor state data.
 *  @param[in]  noAnchors       No of anchors represented in anchorState.
 *  @param[in]  tagState        Tag state data.
 */
